...
const displayMovements = function (movements) {
  ...
  movements.forEach(function (mov, i) {
    ...
    // готовим переменную для html кода, который будет вставляться на каждой итерации
    const html = `
    ...
    // теперь нам нужно вставить подготовленный html в контейнер. Для этого мы используем метод insertAdjacentHTML и мы вызываем его у контенера, в который мы хотим вставить код
    // метод принимает два аргумента, первый - место куда вставляем, второй сам html код
