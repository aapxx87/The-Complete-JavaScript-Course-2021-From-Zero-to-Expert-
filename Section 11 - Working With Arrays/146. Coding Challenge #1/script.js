...
const juliaDataNew = [a, b]

const kateData = [10, 5, 6, 1, 4]

const twoArr = [...juliaDataNew, ...kateData]
...
const checkDogs = function (arr) {
  ...
  for (const [i, item] of arr.entries()) {
    ...
    const result = item >= 3 ? `Dog number ${i + 1} is an adult, and is ${item} years old.` : `Dog number ${i + 1} is a puppy, and is ${item} years old.`
