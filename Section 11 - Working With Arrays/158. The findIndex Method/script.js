...
btnClose.addEventListener('click', function (e) {
  ...
  // проверяем что введенное имя юзера и пин для удаления корректны
  if (inputCloseUsername.value === currentAccount.username && Number(inputClosePin.value) === currentAccount.pin) {

    // находим индекс нужного элемента в массиве аккаунтов, который нужно удалить
    ...
    // мы должны удалить из массива аккаунтов тот, под которым сейчас нходимся по индесу
    // метод splice аффектит на оснвоной массив, так что результат не нужно сохранять в переменные 
