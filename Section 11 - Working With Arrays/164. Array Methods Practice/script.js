...
// * Step 1 - нужно посчитать сколкьо всего депозитов на банковских счетах

const allDeposits = accounts.map((acc) => acc.movements).flat().filter((acc) => acc > 0).reduce((acc, cur) => acc = acc + cur)

// console.log(allDeposits);

// * Step 2 - нужно посчитать сколько на банковских счетах депозитов от (>=) 1000 - кол-во штук
...
// * Step 3 - создадим объект, который содержит сумму депозитов и выводов при помощи reduce метода
...
// * Step 4 -  this is a nice title -> This Is a Nice Title
