...
// Step 1 - create random color в формате rgb(11, 191, 2)
// генерируем случайное целое число через функцию, которая принимает min и max
const randomInt = (min, max) => Math.floor(Math.random() * (max - min + 1) + min)

// фукнция создания цвета rgb - возвращаем literal куда три раза вставляем функцию randomInt(min, max) - от 0 до 255
const randomColor = () => `rgb(${randomInt(0, 255)}, ${randomInt(0, 255)}, ${randomInt(0, 255)})`

// console.log(randomColor(0, 255));

// вешаем ивентХендлер на весь хедер с кнопками навигации
document.querySelector('.nav__link').addEventListener('click', function (e) {
  ...
  // Stop propagation - останавливаем эффект bubling на parent элементы - но это не самый лучший подход
  // e.stopPropagation()
})
