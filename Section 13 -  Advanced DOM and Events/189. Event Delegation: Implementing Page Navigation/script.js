...
// выбираем нодлист из всех линков в навигации - вешаем ан них ивентхендлер
...
// Step 2 - альтернативный путь
// 1. Add event listener to common parent element
// 2. Determine what element originated the event

document.querySelector('.nav__links').addEventListener('click', function (e) {

  // определяем где ивент на самом деле произошед
  // console.log(e.target);

  e.preventDefault()

  // Matching strategy
  // тут может быть два кейса - сам линк (кнопка) или контенйер самого навбара
  // првоеряем произошло ли событие на линке или на контейнере
  if (e.target.classList.contains('nav__link')) {

    // e.target - элемена на котором произогло событие
