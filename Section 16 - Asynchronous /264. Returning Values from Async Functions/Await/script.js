...
// Step 1 - добавим несколько логов в флоу выполнения процесса
// сначала мы увидим в консоли логи выполненные и только потмо асинхронную функцию

console.log('1: Will get quote');

// const rubRate = getRubQuotes()
// // асинхронная функция всегда возвращает промис, так как процесс получения его занчения происходит фоном и это не нарушает текущего потока выполнения кода
// console.log(rubRate);

// но мы можем обработать этот промис
...
// пример как можно внутри одной асинхронной фукнции использовать другую асинхронную фукнцию
(async function () {
