...
console.log(_iconsSvgDefault1.default);
...
const showRecipe = async function() {
    try {
        ...
        const markup = `
            <div class="spinner">
          <svg>
            <use href="${_iconsSvgDefault1.default}#icon-loader"></use>
          </svg>
        </div>
        ...
        <div class="error">
            <div>
              <svg>
                <use href="${_iconsSvgDefault1.default}#icon-alert-triangle"></use>
              </svg>
            </div>
        ...
        <div class="recipe__details">
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${_iconsSvgDefault1.default}#icon-clock"></use>
            </svg>
          ...
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${_iconsSvgDefault1.default}#icon-users"></use>
            </svg>
            ...
            <div class="recipe__info-buttons">
              <button class="btn--tiny btn--increase-servings">
                <svg>
                  <use href="${_iconsSvgDefault1.default}#icon-minus-circle"></use>
                </svg>
              </button>
              <button class="btn--tiny btn--increase-servings">
                <svg>
                  <use href="${_iconsSvgDefault1.default}#icon-plus-circle"></use>
                </svg>
              </button>
            </div>
          </div>
          ...
          <div class="recipe__user-generated">
            <svg>
              <use href="${_iconsSvgDefault1.default}#icon-user"></use>
            </svg>
          </div>
          <button class="btn--round">
            <svg class="">
              <use href="${_iconsSvgDefault1.default}#icon-bookmark-fill"></use>
            </svg>
          </button>
        </div>
...
<!-- Step 2 -->
            ...
            return `
              ...
              <svg class="recipe__icon">
                <use href="${_iconsSvgDefault1.default}#icon-check"></use>
              </svg>
...
},{"../img/icons.svg":"d8AAi","url:../img/icons.svg":"5jwFy","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"d8AAi":[function(require,module,exports) {
...
},{}]},["kS06O","lA0Es"], "lA0Es", "parcelRequire6311")
